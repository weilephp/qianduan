...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/blog/Public/css/cate.css">
...
<body>
	...
	<nav>
		<ul class="nav">
			<li><a href="/blog/index.php/Home/Index/index" <?php if('/blog/index.php/Home/Cate' == '/blog/index.php/Home/Index'): ?>class="active"<?php endif; ?>>首页</a></li>
			<li><a href="/blog/index.php/Home/Aboutme/index" <?php if('/blog/index.php/Home/Cate' == '/blog/index.php/Home/Aboutme'): ?>class="active"<?php endif; ?>>关于我</a></li>
				...
				<div class="content-body clearfix">
					<div class="content-body-left">
						<ul class="content-list">
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="content-list-item">
									<h1><a href="/blog/index.php/Home/Article/index/aid/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h1>
									<div class="media clearfix">
										<?php if($vo['pic'] != ''): ?><img src="/blog/<?php echo ($vo["pic"]); ?>" alt="<?php echo ($vo["title"]); ?>">
										<?php else: ?>
											<img src="/blog/Public/images/no_img.png" alt="暂无缩略图" title="暂无缩略图"><?php endif; ?>
										<div class="media-left">
											<p><?php echo ($vo["descr"]); ?></p>
											<a href="/blog/index.php/Home/Article/index/aid/<?php echo ($vo["id"]); ?>">阅读全文&gt;&gt;</a>
										</div>
									</div>
									<p><span>发布时间：<?php echo (substr($vo["time"],0,10)); ?></span><span>分类：[<?php echo ($vo["catename"]); ?>]</span></p>
								</li><?php endforeach; endif; else: echo "" ;endif; ?>
							<div class="page-wrap">
								<div class="page">
									<?php echo ($show); ?>
								</div>
								<?php if($total_page != 1): ?><form action="/blog/index.php/Home/Cate/datePage" method="post" class="page-select">
										<input type="hidden" name="Ym" value="<?php echo ($dateMon); ?>" >
										<select name="p" id="page" count="<?php echo ($total_page); ?>" style="font-size: 14px;">
										</select>
										<input type="submit" name="" value="跳转" class="tiaozhuan">
									</form><?php endif; ?>
							</div>
						</ul>
					</div><!--内容部分左边结束-->
