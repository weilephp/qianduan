		...
		<div class="content-right">
	        ...
	        <div class="result-list">
	        	<div class="result-content">
                    <form method="post" action="/blog/index.php/Admin/Article/edi" enctype="multipart/form-data">
    	        		...
    	        		<table class="add-table">
    	        			<tr>
                                ...
                                <td>
                                    <select name="cateid" id="cateid" class="required">
                                        ...
                                        <?php if(is_array($catedata)): $i = 0; $__LIST__ = $catedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $data['cateid']): ?>selected<?php endif; ?>><?php echo ($vo["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>文章描述：</th>
                                <td><textarea class="common-textarea" name="descr" rows="5"><?php echo ($data["descr"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>缩略图：</th>
                                <td>
                                    <input name="pic" id="" type="file">
                                    <?php if($data['pic'] != ''): ?><img src="/blog/<?php echo ($data["pic"]); ?>" alt="<?php echo ($data["title"]); ?>" width="70px" height="40px">
                                    <?php else: ?>
                                        暂无缩略图<?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input name="recommend" id="" type="radio" value="是"  class="is-recommend" <?php if($data['recommend'] == '是'): ?>checked<?php endif; ?>>是
                                    <input name="recommend" id="" type="radio" value="否" class="is-recommend" <?php if($data['recommend'] == '否'): ?>checked<?php endif; ?>>否
                                </td>
                            </tr>
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" rows="10"><?php echo ($data["content"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
