...
<head>
	...
	<script type="text/javascript" src="http://localhost/blog/Application/Admin/Public/js/link.js"></script>
</head>
<body>
		...
		<div class="content-right">
	        ...
	        <div class="result-list">
	        	<div class="result-operation">
	        		<a href="/blog/index.php/Admin/Link/add"><i class="iconfont icon-document"></i>新增链接</a>
	        	...
	        	<div class="result-content">
	        		<table id="result_table">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><a href="<?php echo ($vo["url"]); ?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["url"]); ?></a></td>
                                <td><?php echo ($vo["descr"]); ?></td>
                                <td>
                                    <a class="link-update" href="/blog/index.php/Admin/Link/edi/linkid/<?php echo ($vo["id"]); ?>">修改</a>
                                    <a class="del" href="/blog/index.php/Admin/Link/del/linkid/<?php echo ($vo["id"]); ?>">删除</a>
                                </td>
