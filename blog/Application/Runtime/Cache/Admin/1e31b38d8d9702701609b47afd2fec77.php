...
<head>
	...
	<script type="text/javascript" src="http://localhost/blog/Application/Admin/Public/js/cate.js"></script>
</head>
<body>
		...
		<div class="content-right">
	        ...
	        <div class="result-list">
	        	<div class="result-operation">
	        		<a href="/blog/index.php/Admin/Cate/add"><i class="iconfont icon-document"></i>新增栏目</a>
	        		<a href="#" id="pl_del"><i class="iconfont icon-document"></i>批量删除</a>
	        		<a href="#" id="sort"><i class="iconfont icon-document"></i>更新排序</a>
	        	</div>
	        	<div class="result-content">
	        		<table id="result_table">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <input name="ord" value="<?php echo ($vo["sort"]); ?>" type="text" class="sort-text">
                                </td>
                                <td><?php echo ($vo["id"]); ?></td>
                                <td><?php echo ($vo["catename"]); ?></td>
                                <td>
                                    <a class="link-update" href="/blog/index.php/Admin/Cate/edi/cateid/<?php echo ($vo["id"]); ?>">修改</a>
                                    <a class="del" href="/blog/index.php/Admin/Cate/del/cateid/<?php echo ($vo["id"]); ?>">删除</a>
                                </td>
